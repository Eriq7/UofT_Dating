...
const UOFT_BLUE = '#002A5C'; // UofT-ish deep blue (can tweak later)
  ...
  return (
    ...
    >
      {state.routes.map((route, index) => {
        ...
        // ✅ keep original behavior; only swap purple -> UofT blue
        const iconBackgroundColor = (() => {
          if (appThemeName === 'dark') {
            return isFocused ?  '#ffffff' : '#000000';
          } else {
            return isFocused ?  '#ffffff' : UOFT_BLUE;
          }
        })();
        ...
        const backgroundColor = (() => {
          ...
          return appThemeName === 'dark' ? '#000000' : UOFT_BLUE;
        })();
...
const WebBar = ({state, navigation, tabBarStyle, descriptors}) => {
  ...
  return (
    <ScrollView
      style={{
        height: '100%',
        // ✅ keep original background behavior; only swap purple -> UofT blue
        backgroundColor: appThemeName === 'dark' ? 'black' : UOFT_BLUE,
        borderRightWidth: 5,
        borderColor: 'black',
      }}
